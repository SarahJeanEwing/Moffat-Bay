...
VALUES
    ...
    ('A7e3G5bH', 10413, 29, '2025-02-01', '2025-04-30', TRUE, FALSE),
    ...
    ('Q1z8X6hM', 10366, 2, '2025-01-01', '2025-02-28', TRUE, TRUE),
    ('T2g5J7lP', 10354, 4, '2024-12-01', '2025-03-11', TRUE, FALSE),
    ('H8r3S1kF', 10349, 5, '2025-01-01', '2025-09-30', TRUE, TRUE),
    ('W6v9A2pD', 10338, 3, '2025-01-01', '2025-04-30', TRUE, FALSE),
    ('L4y7T8mQ', 10325, 1, '2025-01-01', '2025-03-31', TRUE, TRUE),
