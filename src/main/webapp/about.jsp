...
<div class="container-wrapper">
    ...
    <div class="about-container">
        ...
        <p><strong>Marina monthly cost:</strong><br>$10 per boat foot + $10 for electric power.<br>
    ...
    <div class="c-info-container">
        ...
        <div class="contact-info">
            ...
            <p><strong>Harbormaster VHF Channel:</strong> #9</p>
            <p><strong>Emergency VHF Channel:</strong> #16</p>
        </div>
    </div>
</div>
</body>
